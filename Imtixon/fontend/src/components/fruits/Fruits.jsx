...
const Fruits = () => {
    ...
    function editDef(e) {
        ...
        fetch(`http://localhost:8080/update_fruits/${id}`, {
            method: 'PUT',
            headers: {
    ...
    function delDef(el) {
        const id = el.id;
        fetch(`http://localhost:8080/delete_fruits/${id}`, {
            method: 'DELETE',
            headers: {
                "Content-Type": "application/json",
            }
    ...
    function postDef(e) {
        e.preventDefault();
        const { name, price, color, img } = e.target;
        fetch(`http://localhost:8080/create_fruits`, {
            method: 'POST',
            headers: {
                "Content-Type": "application/json",
            },
    ...
    return (
        <>
            ...
            <div className="container">
                ...
                <button className='btn_cool' onClick={toggle}>Add fruits</button>
